...
enum msgtype {
	...
	PROF, PHYS, LOCK, MPX, GET_TIME_OF_DAY,	GETSETHOSTNAME,
	OPEN, CLOSE, READ, WRITE, LSEEK, STAT, FSTAT, UNLINK, 
	MOUNT, UMOUNT, MKDIR, CHROOT, CHDIR, FCHDIR, ACCESS, 
	UMASK, DUP, IOCTL, FCNTL, CHMOD, FCHMOD, GETDENTS,
	SUSPEND_PROC, RESUME_PROC, EXEC, WAIT, KILL, ACCT, 
	BRK, GETSETID, ALARM, SIGACTION, SIGPROCMASK, SIGSUSPEND,
	PROCCTL, MMAP, FORK, EXIT,
