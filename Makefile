...
kvm-disk:
	@qemu-system-x86_64 -smp 2 -net nic,model=rtl8139 -net user -drive id=hda,file=lyos-disk.img,format=raw,if=none -device virtio-blk-pci,drive=hda -m 2048 -serial stdio -vga std -sdl -cpu host,pmu=true --enable-kvm
