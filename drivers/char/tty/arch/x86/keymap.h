...
/* scan-code			!Shift		Shift		E0 XX	     Ctrl*/
/* ================================================================================= */
/* 0x00 - none		*/	0,		0,		0,		0,
/* 0x01 - ESC		*/	ESC,		ESC,		0,		0,
/* 0x02 - '1'		*/	'1',		'!',		0,		0,
/* 0x03 - '2'		*/	'2',		'@',		0,		0,
/* 0x04 - '3'		*/	'3',		'#',		0,		0,
/* 0x05 - '4'		*/	'4',		'$',		0,		0,
...
/* 0x1D - l. Ctrl	*/	CTRL_L,		CTRL_L,		CTRL_R,		CTRL_L,
/* 0x1E - 'a'		*/	'a',		'A',		0,		C('a'),
/* 0x1F - 's'		*/	's',		'S',		0,		C('s'),
/* 0x20 - 'd'		*/	'd',		'D',		0,		C('d'),
/* 0x21 - 'f'		*/	'f',		'F',		0,		C('f'),
...
/* 0x28 - '\''		*/	'\'',		'"',		0,		0,
/* 0x29 - '`'		*/	'`',		'~',		0,		0,
/* 0x2A - l. SHIFT	*/	SHIFT_L,	SHIFT_L,	0,		0,
/* 0x2B - '\'		*/	'\\',		'|',		0,		C('\\'),
/* 0x2C - 'z'		*/	'z',		'Z',		0,		C('z'),
/* 0x2D - 'x'		*/	'x',		'X',		0,		C('x'),
/* 0x2E - 'c'		*/	'c',		'C',		0,		C('c'),
...
/* 0x34 - '.'		*/	'.',		'>',		0,		0,
/* 0x35 - '/'		*/	'/',		'?',		PAD_SLASH,	0,
/* 0x36 - r. SHIFT	*/	SHIFT_R,	SHIFT_R,	0,		0,
/* 0x37 - '*'		*/	'*',		'*',    	0,		0,
/* 0x38 - ALT		*/	ALT_L,		ALT_L,  	ALT_R,		0,
/* 0x39 - ' '		*/	' ',		' ',		0,		0,
/* 0x3A - CapsLock	*/	CAPS_LOCK,	CAPS_LOCK,	0,		0,
/* 0x3B - F1		*/	F1,		F1,		0,		0,
/* 0x3C - F2		*/	F2,		F2,		0,		0,
/* 0x3D - F3		*/	F3,		F3,		0,		0,
/* 0x3E - F4		*/	F4,		F4,		0,		0,
...
/* 0x42 - F8		*/	F8,		F8,		0,		0,
/* 0x43 - F9		*/	F9,		F9,		0,		0,
/* 0x44 - F10		*/	F10,		F10,		0,		0,
/* 0x45 - NumLock	*/	NUM_LOCK,	NUM_LOCK,	0,		0,
/* 0x46 - ScrLock	*/	SCROLL_LOCK,	SCROLL_LOCK,	0,		0,
/* 0x47 - Home		*/	PAD_HOME,	'7',		HOME,		0,
/* 0x48 - CurUp		*/	PAD_UP,		'8',		UP,		0,
/* 0x49 - PgUp		*/	PAD_PAGEUP,	'9',		PAGEUP,		0,
/* 0x4A - '-'		*/	PAD_MINUS,	'-',		0,		0,
/* 0x4B - Left		*/	PAD_LEFT,	'4',		LEFT,		0,
/* 0x4C - MID		*/	PAD_MID,	'5',		0,		0,
/* 0x4D - Right		*/	PAD_RIGHT,	'6',		RIGHT,		0,
/* 0x4E - '+'		*/	PAD_PLUS,	'+',		0,		0,
/* 0x4F - End		*/	PAD_END,	'1',		END,		0,
/* 0x50 - Down		*/	PAD_DOWN,	'2',		DOWN,		0,
/* 0x51 - PgDown	*/	PAD_PAGEDOWN,	'3',		PAGEDOWN,	0,
/* 0x52 - Insert	*/	PAD_INS,	'0',		INSERT,		0,
/* 0x53 - Delete	*/	PAD_DOT,	'.',		DELETE,		0,
/* 0x54 - Enter		*/	0,		0,		0,		0,
/* 0x55 - ???		*/	0,		0,		0,		0,
/* 0x56 - ???		*/	0,		0,		0,		0,
/* 0x57 - F11		*/	F11,		F11,		0,		0,
/* 0x58 - F12		*/	F12,		F12,		0,		0,	
/* 0x59 - ???		*/	0,		0,		0,		0,	
/* 0x5A - ???		*/	0,		0,		0,		0,	
/* 0x5B - ???		*/	0,		0,		GUI_L,		0,	
/* 0x5C - ???		*/	0,		0,		GUI_R,		0,	
