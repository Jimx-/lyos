...
struct vir_region* region_new(vir_bytes vir_base, size_t vir_length,
                                     int flags);
...
struct vir_region* region_find_free_region(struct mmproc* mmp,
                                                  vir_bytes minv,
...
struct vir_region* mmap_region(struct mmproc* mmp, void* addr,
...
int enqueue_vfs_request(struct mmproc* mmp, int req_type, int fd,
...
int page_cache_add(dev_t dev, off_t dev_offset, ino_t ino,
